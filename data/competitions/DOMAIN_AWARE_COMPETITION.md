...
|---------|-----------|-------------|-------------|-------------|--------|
| A-full-cortex          | 0.909 | 0.388 | **0.462** | 1.799 | 12 |
| B-no-feedback          | 0.909 | 0.388 | **0.462** | 1.793 | 10 |
| C-no-modulation        | 0.909 | 0.388 | **0.462** | 1.842 | 10 |
| D-inhibitor-only       | 0.909 | 0.388 | **0.462** | 1.283 | 5 |
| E-pre-cortex           | 0.800 | 0.455 | **0.503** | 1.075 | 4 |
